...
//	}
	...
	public ModelAndView createEmployee(Employee employee) {
		...
		Employee newEmployee = employeeRepository.save(new Employee(employee.getFirstName(), employee.getLastName(), 
														employee.getIsAdmin(), employee.getHrsWorked(), 
														employee.getPassWord(),employee.getAddress(), employee.getEmail(),
														employee.getIsEmployed(), employee.getWage(), employee.getPhoneNumber()));
